 ...
 * @param arvore                O nó raiz da árvore de Huffman.
 */
void escrever_cabecalho_no_arquivo(FILE *arquivo_comprimido, int bits_de_lixo, int tamanho_arvore, Arvore *arvore)
{
    //setando os bits
    ...
    //os dois bytes para lixo e para tamanho da arvore sejam escritos corretamente, para isso usamos a funcao htons da biblioteca arpa/inet.h
